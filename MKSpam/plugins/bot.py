...
import sys
import heroku3
from MKSpam import Mig, Mig2, Mig3, Mig4, Mig5 , Mig6, Mig7, Mig8, Mig9, Mig10, OWNER_ID, SUDO_USERS, HEROKU_APP_NAME, HEROKU_API_KEY, MKVersion
from MKSpam import CMD_HNDLR as hl
from telethon.tl.functions.users import GetFullUserRequest
from MKSpam import ALIVE_PIC
from telethon import events, version
from datetime import datetime

MIG_PIC = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/a2beccc714b5f011dd42d.jpg"
...
mighty += f"• **ᴍɪɢʜᴛʏXsᴘᴀᴍ ᴠᴇʀsɪᴏɴ**  : `{MKVersion}`\n"
mighty += f"═══════════════════\n\n"   
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "𝗥𝗲𝘀𝘁𝗮𝗿𝘁𝗶𝗻𝗴 𝗬𝗼𝘂𝗿 𝐌𝐊 𝗫 𝗦𝗽𝗮𝗺... | Please Wait Few Seconds."
