...
from MKSpam import Mig, Mig2, Mig3, Mig4, Mig5 , Mig6, Mig7, Mig8, Mig9, Mig10, SUDO_USERS, OWNER_ID

from MKSpam import CMD_HNDLR as hl
from MKSpam.sql.echo_sql import addecho, is_echo, remove_echo
  ...
  if event.sender_id in SUDO_USERS:
     if event.reply_to_msg_id is not None:
            ...
            if int(user_id) in MKX:
                    text = f"I Can't Echo MKX's Owner"
